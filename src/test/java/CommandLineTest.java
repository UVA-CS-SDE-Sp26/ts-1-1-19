...
public class CommandLineTest {
    ...
    public void setUp() {
        ...
        cli = new CommandLine(); // inject fake
    }

    // Test 1: No args should NOT read file
    @Test
    public void testNoArgsListsFiles() throws Exception {
        cli.run(new String[] {});
    ...
    @Test
    public void testSingleArgReadsFile() throws Exception {
    ...
    @Test
    public void testInvalidArgDoesNothing() throws Exception {
    ...
    @Test
    public void testTwoArgsAcceptsKey() throws Exception {
