...
class ProgramControlTest {
    ...
    public void noFilesInFolder() {
        ...
        assertEquals(1, result.length); // Geehun told me he put in a sample file in there for the tests.
                                        // "File_Example.txt" If it detects 1, then that means it doesn't detect
                                        // anything else.
    }
